...
import backgroundVideo from '../assets/video.mp4'; // Make sure to place the video in the appropriate folder
...
function Home2() {
  return (
    <div className="h-screen w-full relative">
      ...
      <div className="absolute inset-0 bg-black opacity-50 z-0"></div> {/* Optional overlay */}
    </div>
  );
}
